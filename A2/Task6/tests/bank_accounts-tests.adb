...
package body Bank_Accounts.Tests is

   package BA renames Bank_Accounts;

   Local_Bank_Account : aliased Account_Type;
   Local_Transfer_Account : aliased Account_Type;
   ...
   begin
      ...
      BA.Withdraw (T.Bank_Account.all, 10000);
      BA.Withdraw (T.Bank_Account.all, 10000);
      Assert (BA.Get_Balance (T.Bank_Account.all) = 20000,
               "Wrong Balance after Withdraw | Should be: 20000" & " is: " & BA.Get_Balance (T.Bank_Account.all)'Image);
   ...
   begin
      ...
      Assert (BA.Get_Balance (T.Bank_Account.all) = 10000,
               "Wrong Balance after Transfer with Fees | Should be: 10000" & " is: " & BA.Get_Balance (T.Bank_Account.all)'Image);
