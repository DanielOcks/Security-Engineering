...
package body Bank_Accounts.Tests.Suite is

   package Runner is new AUnit.Test_Caller
     (Bank_Accounts.Tests.Test);
   ...
   begin
      Runner.Create (Test_Deposit,
                     "Bank Account : Test Deposit",
                     Test_Depos'Access);
      Runner.Create (Test_Withdraw,
                     "Bank Account : Test Withdraw",
                     Test_WDraw'Access);
      Runner.Create (Test_Transfer,
                     "Bank Account : Test Transfer",
                     Test_Transf'Access);
